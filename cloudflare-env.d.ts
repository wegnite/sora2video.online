/* biome-ignore lint -- Generated by Wrangler */
/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 13dbe96c445cf117947473e91d77ca27)
...
declare namespace Cloudflare {
  interface Env {
    ...
    NEXT_PUBLIC_STRIPE_PRICE_LIFETIME: string;
    NEXT_PUBLIC_STRIPE_PRICE_CREDITS_BASIC: string;
    NEXT_PUBLIC_STRIPE_PRICE_CREDITS_STANDARD: string;
    NEXT_PUBLIC_STRIPE_PRICE_CREDITS_PREMIUM: string;
    NEXT_PUBLIC_STRIPE_PRICE_CREDITS_ENTERPRISE: string;
    DISABLE_IMAGE_OPTIMIZATION: string;
    NEXT_PUBLIC_DEMO_WEBSITE: string;
    NEXT_PUBLIC_GOOGLE_ANALYTICS_ID: string;
    NEXT_PUBLIC_UMAMI_WEBSITE_ID: string;
    NEXT_PUBLIC_UMAMI_SCRIPT: string;
    NEXT_PUBLIC_OPENPANEL_CLIENT_ID: string;
    NEXT_PUBLIC_PLAUSIBLE_DOMAIN: string;
    NEXT_PUBLIC_PLAUSIBLE_SCRIPT: string;
    NEXT_PUBLIC_AHREFS_WEBSITE_ID: string;
    NEXT_PUBLIC_SELINE_TOKEN: string;
    NEXT_PUBLIC_DATAFAST_WEBSITE_ID: string;
    NEXT_PUBLIC_DATAFAST_DOMAIN: string;
    DISCORD_WEBHOOK_URL: string;
    FEISHU_WEBHOOK_URL: string;
    NEXT_PUBLIC_AFFILIATE_AFFONSO_ID: string;
    NEXT_PUBLIC_AFFILIATE_PROMOTEKIT_ID: string;
    NEXT_PUBLIC_TURNSTILE_SITE_KEY: string;
    TURNSTILE_SECRET_KEY: string;
    NEXT_PUBLIC_CRISP_WEBSITE_ID: string;
    CRON_JOBS_USERNAME: string;
    CRON_JOBS_PASSWORD: string;
